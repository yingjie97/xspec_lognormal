...
PROTOCCALLSFSUB7(LNWAB,lnwab,FLOATV,INT,FLOATV,INT,FLOATV,FLOATV,FLOATV)
#define LNWAB(ear,ne,param,ifl,photar,photer,absorb) \
           CCALLSFSUB7(LNWAB,lnwab,FLOATV,INT,FLOATV,INT,FLOATV,FLOATV,FLOATV, \
             ear,ne,param,ifl,photar,photer,absorb)



void lnwabs(const RealArray& energyArray, const RealArray& params,
        int spectrumNumber, RealArray& flux, RealArray& fluxErr, 
        const string& initString)
{
   // Memory allocation wrapper for lnwab
   ...
   LNWAB(ear, ne, pars, spectrumNumber, photar, photer, apAbs.get());   
